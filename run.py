...
def get_args():
    ...
    # forecasting task
    parser.add_argument('--seq_len', type=int, default=24*30, help='input sequence length')
    parser.add_argument('--label_len', type=int, default=24*15, help='start token length')
    parser.add_argument('--pred_len', type=int, default=24*15, help='prediction sequence length')

    # busy hour task
    parser.add_argument('--busy_decoder', type=bool, default=True, help='if busy forecast')
    parser.add_argument('--busy_ratio', type=int, default=0.5, help='hybrid level of loss')
    ...
    parser.add_argument('--with_shift',type=str,default='ws',help='use_shift_hour_stationary')
    # model define
